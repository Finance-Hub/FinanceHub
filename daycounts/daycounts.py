...
class DayCounts(object):
    ...
    def dib(self, d1=None, d2=None):
        ...
        array if two conditions are simoutanesouly met:
    ...
    def hasleap(self, d1, d2):
        ...
        there seems to be a consensus between OpenGamma, Algorithmics and
        Wikipedia that the interval is [d1, d2).
    ...
    def isbus(self, d):
        """True is date is a business day"""
        return self.following(d) == d

    def busdateroll(self, d, roll=None):
    ...
    def modified_following(self, d):
        ...
        return self.busdateroll(d, 'modified_following')
    ...
    def eom(d, offset=0):
        ...
        # the last date of month. We leave the offset to a different funtion
    ...
    @weekmask.setter
    def weekmask(self, x):
        # TODO: Is this what is causing the incompatibility with newer versions of Numpy? Check it
    ...
    @staticmethod
    def parse_dc(dc):
        """"Given string, code attemps to parse it to something known in the
    ...
    def parse_xx360_dc(dc):
        ...
        if dc == 'BOND BASIS' or dc == '30/360':
            ...
            dc = '30E/360'
        elif '30/360' in dc and 'GERMAN' in dc:  # This case needs to be this same block
            dc = '30E/360 ISDA'
    ...
    def _date_parser(d1, d2):
        """Given Timestamps or DateTimeIndixes, function splits dates into
    ...
    @staticmethod
    def _simple_cast(d):
        """Cast date into Timestamp or mumpy datetime64[D] array"""
        d = to_datetime(d)
